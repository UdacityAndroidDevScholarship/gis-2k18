...
public class EditProfileGISProjectsAdapter extends RecyclerView.Adapter<EditProfileGISProjectsAdapter.EditProfileGISProjectsViewHolder>{
    ...
    public EditProfileGISProjectsAdapter(Context mContext) {
        this.mContext = mContext;
    }

    class  EditProfileGISProjectsViewHolder extends RecyclerView.ViewHolder{

        ImageView ivProfileGISProjects;
        public  EditProfileGISProjectsViewHolder(View itemView) {
            super(itemView);
    ...
    @Override
    public EditProfileGISProjectsAdapter.EditProfileGISProjectsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new EditProfileGISProjectsAdapter.EditProfileGISProjectsViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(EditProfileGISProjectsAdapter.EditProfileGISProjectsViewHolder holder, int position) {
